...
client.login("NDgzNTExMjgzNzk5NTU2MTA2.DuLXpA.o165_tilaJ5Pe6QYfcsQIcYgUdc")
client.on('message', (message) => {
    ...
    if(message.content=="#info"){
        let user = message.mentions.members.first();
                if (!user) user = message.member;
                let av = new Discord.RichEmbed()
                    .setAuthor('CubeBot', 'https://cdn.discordapp.com/attachments/516196452905648128/518393165359742977/09.JPG')
                    ...
                    .addField("Партнёры:","-")
                    .setThumbnail('https://cdn.discordapp.com/attachments/516196452905648128/518393165359742977/09.JPG')
                    .setColor("40E0D0")
                    .setFooter('Мишутка ♔#1483 © 2018 | Legacy Program','https://cdn.discordapp.com/attachments/495534456875253770/518060896182861834/Screenshot_9.png')
                message.channel.send({embed: av});
    }
